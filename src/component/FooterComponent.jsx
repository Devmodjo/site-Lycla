...
export function Footer() {
  return (
    <footer className="bg-light w-100">
      ...
      <br />
      <span className="container d-flex justify-content-center"><i>develloped by <a href="https://modjovictor.netlify.app" target="_blank" style={styleLink}><b>Modjo victor</b></a> <br /> Lycee Classique de Dschang 2025 &copy; all right reserved</i></span>
    </footer>
  );
}
